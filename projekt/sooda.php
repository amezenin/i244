...
<html>
  ...
  <table>
  <tr><td>Biomass (kg) </td><td><input TYPE="number" name="a" value="" placeholder="1000" /></td><tr/>
 
 <tr><td>Sööda kogus päevas (%)</td><td> <input TYPE="number" name="b" value="" placeholder="1.2" /></td></tr>
 <tr><td>Söödakoefitsient (FCR) </td><td> <input TYPE="number" name="c" value="" placeholder="1.2" /></td></tr>
 <tr><td>Päevade arv </td><td> <input TYPE="number" name="n" value="" placeholder="11" /></td></tr>
